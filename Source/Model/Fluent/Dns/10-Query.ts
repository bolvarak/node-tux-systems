...
export default class DnsQuery extends Model<DnsQuery> {
	...
	request!: {method: string, parameters: ({zonename: string, domain_id?: number}|{qtype: string, qname: string, remote: string, local: string, 'real-remote': string, 'zone-id': number})};
	...
	response!: {result: boolean|PowerDnsRecord[], log: string[]};

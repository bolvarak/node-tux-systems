...
// We need the Express XML parser module
let $expressXmlBodyParser = require('body-parser-xml')($expressBodyParser);
...
// We need to parse XML POST data
$application.use($expressBodyParser.xml({
	'limit': '256MB',
	'xmlParseOptions': {
		'attrkey': '@',
		'charkey': '$',
...
$application.use(require('./Common/Middleware/Response'));
// We need some custom functionality added to our request object
$application.use(require('./Common/Middleware/Request'));
...
$application.use(require('./Endpoint/Index'));

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// 404 - Not Found Handler //////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

$application.use(require('./Common/Middleware/NotFound'));

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// 500/Error Handler ////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

$application.use(require('./Common/Middleware/InternalServerError'));

...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public async a($name: string, $ttl: number, $content: string, $auth: boolean = true): Promise<ModelPowerDNSResult> {
		...
		let $record: PowerDnsRecord = new PowerDnsRecord();
		// Define the type
		$record.qtype = 'A';
		// Define the name
		$record.qname = $name;
	...
	// public async dnssec($name: string, $ttl: number, $flags: number, $tag: string, $content: string, $auth: boolean = true): Promise<ModelPowerDNSResult> {
